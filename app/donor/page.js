      ...
      <div className="min-h-screen mx-36 py-6">
        <div className="flex justify-around items-center py-28">
          <div className="flex flex-col gap-5">
            <h1 className="font-extrabold text-6xl w-header drop-shadow-custom z-[-1]">Make a difference with just a few clicks</h1>
            <h5 className="font-semibold text-lg w-subheader">Transparency, security, and efficiency: Donate to our blockchain-based charity system and be confident your contribution will make a difference</h5>
          </div>
          <Image className="h-miniheader w-miniheader" src={"/security-badge.png"} height={1000} width={1000} alt="security" />
        </div>
                    ...
                    if (project.status !== "pending") {
                      ...
                      return <div key={index} className="flex flex-col gap-2 w-96 bg-whitish text-dark rounded">
                        ...
                        <div className="pt-2 pb-6 px-6 flex flex-col gap-3">
                          ...
                          <button onClick={() => router.push(`/donor/${project._id}`)} className="p-3 bg-darkGreenish rounded text-whitish">View</button>
                        </div>
                      </div>
                    }
                  })
